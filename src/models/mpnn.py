...
One class, two configurations via `use_features`:
  ...
  MPNN3 (use_features=True):  graph + external precomputed features — our rmoldes (316),
                              ...
                              closest analogue to MPNN2's CDF; previously RobustScaler, which was a
...
class ChempropRegressor(BaseEstimator, RegressorMixin):
    ...
    Three feature configurations (mutually exclusive):
      ...
      MPNN3: use_features=True,  features_generator=None — graph + EXTERNAL precomputed features
      ...
      MPNN2: use_features=False, features_generator='rdkit_2d_normalized' — graph + ChemProp's OWN
             ...
             variant (Fang et al. use rdkit_2d_normalized); MPNN3 deviates by reusing our 316 rmoldes.
    """
    ...
    def _split_X(self, X):
        ...
        # Only MPNN3/4 carries external features in X; MPNN2's descriptors are generated by ChemProp
...
def tune_mpnn_hyperopt(X, y, use_features=False, features_generator=None,
    ...
    mutually exclusive: use_features=True feeds external features via --features_path (MPNN3);
    features_generator='rdkit_2d_normalized' has ChemProp generate them (MPNN2). num_iters = number
